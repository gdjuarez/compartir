...
<head>
  ...
  <!-- Navbar content -->
	  ...
	  <a href="#" class="navbar-brand"><h2>Subir Actividades a 4°C</h2></a>
				   	...
				   	<div class="row align-items-center p-4">
						...
						<div class="col-md-8">	
							...
							<div class="list-group" >		   		 
					         ...
					         <form action="file4c.php" method="post" enctype="multipart/form-data" >								
                        ...
                        // $carpeta=$_POST['carpeta'];
						 ...
						 if($_POST['carpeta']=='Seleccione Asignatura'){
						  ...
						  $direccion= "../actividades/contenidos4c/".$carpeta."/";
                        ...
                        // $carpeta=$_POST['carpetarepo'];
                         ...
                         if($_POST['carpetarepo']=='Seleccione Asignatura'){
								...
								$direccion= "../actividades/contenidos4c/".$carpetarepo."/repositorio";  
