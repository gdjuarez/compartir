...
<html>
  ...
  <!-- Navbar content -->
	  ...
	  <a href="#" class="navbar-brand"><h2>Subir actividades a 6°B</h2></a>
				   	...
				   	<div class="row align-items-center p-4">
						...
						<div class="col-md-8">	
							...
							<div class="list-group" >		   		 
					         ...
					         <form action="file6b.php" method="post" enctype="multipart/form-data" >								
								<p><select class="form-control input-sm" id="asignatura" name="asignatura" title='Seleccione Asignatura.'>
									...
									<option value="Proyecto de Produccion en Artes Visuales">Proyecto de Produccion en Artes Visuales</option>  
                        ...
                        <?php
                         ...
                         if($_POST['carpeta']=='Seleccione Asignatura'){
						  ...
						  $direccion= "../actividades/contenidos6b/".$carpeta."/";
					...
					<div class="p-3 mb-4 bg-light text-dark border border-secondary rounded">
                        ...
                        // $carpeta=$_POST['carpetarepo'];
                         ...
                         if($_POST['carpetarepo']=='Seleccione Asignatura'){
								...
								$direccion= "../actividades/contenidos6b/".$carpetarepo."/repositorio";  
