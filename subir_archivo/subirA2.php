...
<html>
  ...
  <!-- Navbar content -->
	  ...
	  <a href="#" class="navbar-brand"><h2>Subir Actividades Aceleracion 2</h2></a>
				   	...
				   	<div class="row align-items-center p-4">
						...
						<div class="col-md-8">	
							...
							<div class="list-group" >		   		 
					         ...
					         <form action="fileA2.php" method="post" enctype="multipart/form-data" >								
								<p><select class="form-control input-sm" id="asignatura" name="asignatura" title='Seleccione Asignatura.'>
					                    ...
					                    <option value="Practica del Lenguaje">Practica del Lenguaje</option>                      						
								</select></p>
							...
							<div class="list-group" >		   		 
					 			<button type="button" class="list-group-item list-group-item-success ">Ver Producciones Entregadas</button>
					         </div>
							 <form action="" method="post" class="p-2 mb-4">								
								...
								<input type="submit" value="Ver " class="p-2 mb-4"></input>
							</form>
                        ...
                        <?php
						 ...
						 if($_POST['carpeta']=='Seleccione Asignatura'){
						  ...
						  $direccion= "../actividades/contenidosA2/".$carpeta."/";
					...
					<div class="p-3 mb-4 bg-light text-dark border border-secondary rounded">
                        ...
                        // $carpeta=$_POST['carpetarepo'];
                         ...
                         if($_POST['carpetarepo']=='Seleccione Asignatura'){
								...
								$direccion= "../actividades/contenidosA2/".$carpetarepo."/repositorio";  
