...
<html>
  ...
  <!-- Navbar content -->
	  ...
	  <a href="#" class="navbar-brand"><h2>Subir Actividades a 5°B</h2></a>
	       ...
	       <button class="btn btn-outline-danger sm" type="submit">usuario: <?php echo $_SESSION['user']?> <br>cerrar-sesion</button>
			 ...
			 <div class="container">
				   	<div class="row align-items-center p-4">
				        <div class="col-md-3">	
				        	<div class="p-3 mb-3 bg-light text-dark border border-secondary rounded">
						...
						<div class="col-md-8">	
							...
							<div class="list-group" >		   		 
					         ...
					         <form action="file5b.php" method="post" enctype="multipart/form-data" >								
								<p><select class="form-control input-sm" id="asignatura" name="asignatura" title='Seleccione Asignatura.'>
									...
									<option  value="Arte (Lenguaje Complementario)">Arte (Lenguaje Complementario)</option>
									<option value="Educacion Fisica">Educacion Fisica</option>
									<option  value="Geografia">Geografia</option>  
									<option  value="Historia">Historia</option> 
									<option  value="Imagen y Nuevos Medios">Imagen y Nuevos Medios</option>                     
									<option  value="Imagen y Procedimientos Constructivos">Imagen y Procedimientos Constructivos</option> 
									<option  value="Ingles">Inglés</option>  
									<option  value="Introduccion a la Quimica">Introduccion a la Quimica</option>
									<option  value="Literatura">Literatura</option> 
									<option  value="Matematica-Ciclo Superior">Matemática-Ciclo Superior</option>
									<option  value="Politica y Ciudadania">Politica y Ciudadania</option>  
								</select></p>
                        ...
                        <?php
						 ...
						 if($_POST['carpeta']=='Seleccione Asignatura'){
						  ...
						  $direccion= "../actividades/contenidos5b/".$carpeta."/";
                        ...
                        // $carpeta=$_POST['carpetarepo'];
                         ...
                         if($_POST['carpetarepo']=='Seleccione Asignatura'){
								...
								$direccion= "../actividades/contenidos5b/".$carpetarepo."/repositorio";  
