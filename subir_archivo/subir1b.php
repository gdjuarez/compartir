...
<html>
  ...
  <!-- Navbar content -->
	  ...
	  <a href="#" class="navbar-brand"><h2>Subir Actividades a Primero B</h2></a>
				   	...
				   	<div class="row align-items-center p-4">
						...
						<div class="col-md-8">	
							...
							<div class="list-group" >		   		 
					         ...
					         <form action="file1b.php" method="post" enctype="multipart/form-data" >								
                        ...
                        // $carpeta=$_POST['carpeta'];
                         ...
                         if($_POST['carpeta']=='Seleccione Asignatura'){
								...
								$direccion= "../actividades/contenidos1b/".$carpeta."/";
                        ...
                        // $carpeta=$_POST['carpetarepo'];
                         ...
                         if($_POST['carpetarepo']=='Seleccione Asignatura'){
								...
								$direccion= "../actividades/contenidos1b/".$carpetarepo."/repositorio";  
