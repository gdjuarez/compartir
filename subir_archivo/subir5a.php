...
<html>
  ...
  <!-- Navbar content -->
	  ...
	  <a href="#" class="navbar-brand"><h2>Subir Actividades a 5°A</h2></a>
				   	...
				   	<div class="row align-items-center p-4">
						...
						<div class="col-md-8">	
							...
							<div class="list-group" >		   		 
					         ...
					         <form action="file5a.php" method="post" enctype="multipart/form-data" >								
								<p><select class="form-control input-sm" id="asignatura" name="asignatura" title='Seleccione Asignatura.'>
									...
									<option value="Comunicacion Cultura y Sociedad">Comunicacion Cultura y Sociedad</option>                     
                        ...
                        <?php
						 ...
						 if($_POST['carpeta']=='Seleccione Asignatura'){
						  ...
						  $direccion= "../actividades/contenidos5a/".$carpeta."/";
                        ...
                        // $carpeta=$_POST['carpetarepo'];
                         ...
                         if($_POST['carpetarepo']=='Seleccione Asignatura'){
								...
								$direccion= "../actividades/contenidos5a/".$carpetarepo."/repositorio";  
