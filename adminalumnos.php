...
<body>
      ...
      <div class="col-md-8">
        <p class="h1">Ingreso con contraseña:</p>
          <form class="form-inline" action="loginalumnos.php" method="post">
...
<HR>
<div>
          <img src="img/pass.jpg" class="img-fluid rounded" alt="Responsive image">
        </div>
        <HR>
