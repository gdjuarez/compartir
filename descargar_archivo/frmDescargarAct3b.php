  ...
  <head>
   ...
   <header>
    ...
    <!-- Navbar content -->
      ...
      <a href="#" class="navbar-brand"><h2>Actividades 3°B</h2></a>
 ...
 <body>
  ...
  <div class="container">
          ...
          <div class="p-3 mb-4 bg-light text-dark border border-secondary">
                ...
                <input type="text"  id="curso" value="3b" hidden /> 
                <input type="text" id="direccion" value="../actividades/contenidos3b/" hidden></input>               
