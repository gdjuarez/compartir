  ...
  <head>
   ...
   <header>
    ...
    <!-- Navbar content -->
      ...
      <a href="#" class="navbar-brand"><h2>Actividades 2° B</h2></a>
  ...
  <div class="container">
        ...
        <div class="col-md-6">            
          ...
          <div class="p-3 mb-4 bg-light text-dark border border-secondary">
                ...
                <input type="text"  id="curso" value="2b" hidden /> 
                <input type="text" id="direccion" value="../actividades/contenidos2b/" hidden></input>               
