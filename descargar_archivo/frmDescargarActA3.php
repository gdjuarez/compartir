  ...
  <head>
   ...
   <header>
    ...
    <!-- Navbar content -->
      ...
      <a href="#" class="navbar-brand"><h2>Actividades Aceleracion 3</h2></a>
 ...
 <body>
  ...
  <div class="container">
        ...
        <div class="col-md-6">            
			   ...
			   <div class="col-md-6">
          <p align="center">(Aceleracion 3)</p> 
          <div class="p-3 mb-4 bg-light text-dark border border-secondary">
                ...
                <option value="0">Seleccione Asignatura</option>  
                    ...
                    <option value="Practica del Lenguaje">Prácticas del Lenguaje</option>                       
                </select></p>
                <input type="text"  id="curso" value="A3" hidden /> 
                <input type="text" id="direccion" value="../actividades/contenidosA3/" hidden></input>               
