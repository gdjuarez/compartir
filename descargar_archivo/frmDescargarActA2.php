  ...
  <head>
   ...
   <header>
    ...
    <!-- Navbar content -->
      ...
      <a href="#" class="navbar-brand"><h2>AcTividades Aceleracion 2</h2></a>
 ...
 <body>
  ...
  <div class="container">
        ...
        <div class="col-md-6">            
			   ...
			   <div class="col-md-6">
          <p align="center">(Aceleracion 2)</p> 
          <div class="p-3 mb-4 bg-light text-dark border border-secondary">
                ...
                <input type="text"  id="curso" value="A2" hidden /> 
                <input type="text" id="direccion" value="../actividades/contenidosA2/" hidden></input>               
