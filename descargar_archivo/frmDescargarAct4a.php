  ...
  <head>
   ...
   <header>
    ...
    <!-- Navbar content -->
      ...
      <a href="#" class="navbar-brand"><h2>Actividades 4°A</h2></a>
  ...
  <div class="container">
        ...
        <div class="col-md-6">            
          ...
          <div class="p-3 mb-4 bg-light text-dark border border-secondary">
                ...
                <div class="list-group" > 
                 <button type="button" class="list-group-item list-group-item-success ">Recibir Producciones </button>
                </div>
               <form action="" method="post" class="p-2 mb-4">                
                ...
                <input type="text"  id="curso" value="4a" hidden /> 
                <input type="text" id="direccion" value="../actividades/contenidos4a/" hidden></input>               
