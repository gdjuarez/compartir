  ...
  <head>
   ...
   <header>
    ...
    <!-- Navbar content -->
      ...
      <a href="#" class="navbar-brand"><h2>Actividades 2° A</h2></a>
        ...
        <div class="col-md-6">            
          ...
          <div class="p-3 mb-4 bg-light text-dark border border-secondary">
               ...
               <option value="0">Seleccione Asignatura</option> 
                ...
                <input type="text"  id="curso" value="2a" hidden /> 
                <input type="text" id="direccion" value="../actividades/contenidos2a/" hidden></input>               
