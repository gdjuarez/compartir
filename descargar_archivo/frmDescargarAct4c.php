  ...
  <head>
   ...
   <header>
    ...
    <!-- Navbar content -->
      ...
      <a href="#" class="navbar-brand"><h2>Actividades 4°C</h2></a>
        ...
        <div class="col-md-6">            
          ...
          <div class="p-3 mb-4 bg-light text-dark border border-secondary">
               ...
               <form action="" method="post" class="p-2 mb-4">                
                ...
                <input type="text"  id="curso" value="4c" hidden /> 
                <input type="text" id="direccion" value="../actividades/contenidos4c/" hidden></input>               
